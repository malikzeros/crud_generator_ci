...
<html>
    ...
    <body>
		...
		<th>Action</th>
			...
			<td><?php echo $log->proxy ?></td>
			<td><?php echo $log->via ?></td>
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('log/read/'.$log->id_log),'Read'); 
				echo ' | '; 
				echo anchor(site_url('log/update/'.$log->id_log),'Update'); 
				echo ' | '; 
				echo anchor(site_url('log/delete/'.$log->id_log),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
